    ...
    <section>
        ...
        <div class="row g-0">
            ...
            <div class="col-sm-12 col-lg-8 col-xl-9 h-screen">
                <nav class="navbar">
                    <div class="container-fluid">
                        <p class="font-body font-semibold text-2xl mx-3 mt-20 lg:mt-5 text-slate-700 hover:text-slate-700 navbar-brand">Edit net library</p>
                    </div>
                </nav>
                <div class="mt-4 pb-2">
                    <div class="card mx-4 rounded-3 border-slate-400/75">
                        <div class="card-body bg-slate-300 font-body text-slate-700 rounded-3 shadow-md">
                            <form method="POST" action="{{ route('update.library', $library_info->id) }}">
                                @csrf
                                @method('put')
                                <div class="form-group">
                                    <label class="text-lg font-medium" for="nameInput">Library Name <span class="text-xs">(required)</span></label>
                                    <input class="w-full bg-slate-200 outline-[0.5px] outline-slate-400/60 px-2 h-8 text-base rounded-3 mb-2" type="text" id="nameInput" name="library_name" autocomplete="off" placeholder="{{ $library_info->library_name }}" value="{{ $library_info->library_name }}">
                                    <label class="text-lg font-medium" for="urlInput">Library Url <span class="text-xs">(required)</span></label>
                                    <input class="w-full bg-slate-200 outline-[0.5px] outline-slate-400/60 px-2 h-8 text-base rounded-3 mb-4" type="text" id="urlInput" name="library_url" autocomplete="off" placeholder="{{ $library_info->library_url }}" value="{{ $library_info->library_url }}">
                                    </div>
                                    <div class="row g-0 text-center pt-1">
                                        <a href="{{ url('/home/libraries') }}" class="text-lg font-medium w-1/2 bg-slate-200 hover:bg-slate-100/75 outline-[0.5px] outline-slate-400/60 px-2 py-1.5 text-base rounded-start-3 mb-2 border-e border-slate-400/25">Cancel</a>
