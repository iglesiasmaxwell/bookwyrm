        ...
        <div class="row g-0">
            <div class="col-lg-4 col-xl-3 bg-gradient-to-b from-slate-300 h-full d-none d-lg-block">
                ...
                <div class="py-4 pl-10">
                    ...
                    <a href="{{ url('/home/libraries') }}" class="text-lg text-slate-700 hover:text-slate-600 navbar-text list-group-item-unstyled">Net Library</a>
                    <br>
                    <a href="{{ url('/home/about') }}" class="text-lg text-slate-700 hover:text-slate-600 navbar-text list-group-item-unstyled bg-slate-200 rounded-s-lg pl-5">About</a>
                </div>
                </div>
            </div>
            
            <div class="col-sm-12 col-lg-8 col-xl-9 h-screen">
                <div class="flex justify-content-center self-center g-0 mt-72">
                    <a href="{{ url('https://github.com/iglesiasmaxwell/bookwyrm') }}" class="font-logo text-4xl md:text-6xl lg:text-7xl text-slate-700 hover:text-slate-600 focus:text-slate-600 shadow-md px-3 pt-1.5 rounded-md bg-slate-300/25 hover:bg-slate-400/25 focus:bg-slate-400/25 rounded-t-xl"><i class="fa fa-bookmark" aria-hidden="true"></i> bookwyrm</a>
                </div>
                <div class="mt-3 flex justify-content-center self-center g-0 font-body text-slate-700 text-base md:text-lg lg:text-xl mb-72">
                    <h5><span class="text-xs md:text-sm lg:text-base">made by</span> iglesiasmaxwell</h5>
                </div>
            </div>
        </div>
    </section>
