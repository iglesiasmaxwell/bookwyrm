    ...
    <section>
        ...
        <div class="row g-0">
            <div class="col-lg-4 col-xl-3 bg-gradient-to-b from-slate-300 h-full d-none d-lg-block">
                <div class="py-4 pl-10">
                    ...
                    <div class="mt-16 leading-3 overflow-y-auto font-body font-medium list-group rounded-0">
                        ...
                        <a href="{{ url('/home/planning') }}" class="text-lg text-slate-700 hover:text-slate-600 navbar-text list-group-item-unstyled">Planning</a>
                        <br>
                        <a href="{{ url('/home/completed') }}" class="text-lg text-slate-700 hover:text-slate-600 navbar-text list-group-item-unstyled bg-slate-200 rounded-s-lg pl-5">Completed</a>
                    </div>
                </div>
                <hr class="border-2 border-slate-400/50">
                <div class="py-4 pl-10">
            ...
            <div class="col-sm-12 col-lg-8 col-xl-9 h-screen">
                <nav class="navbar">
                    <div class="container-fluid">
                        <p class="font-body font-semibold text-2xl mx-3 mt-16 text-slate-700 hover:text-slate-700 navbar-brand d-block d-lg-none">Completed</p>
                    </div>
                ...
                <div class="bg-slate-300/50 mx-7 my-3 font-body rounded-md shadow-md">
                  ...
                  @empty
                    <p class="flex justify-content-center align-self my-44 lg:my-60 font-body text-xl">There's no book on completed</p>
                  @endforelse
                </div>
