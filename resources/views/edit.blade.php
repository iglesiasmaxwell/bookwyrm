    ...
    <section>
        ...
        <div class="row g-0">
            ...
            <div class="col-sm-12 col-lg-8 col-xl-9 h-screen">
                <nav class="navbar">
                    <div class="container-fluid">
                        <p class="font-body font-semibold text-2xl mx-3 mt-20 lg:mt-5 text-slate-700 hover:text-slate-700 navbar-brand">Edit book</p>
                    </div>
                </nav>
                <div class="mt-4 pb-2">
                    <div class="card mx-4 rounded-3 border-slate-400/75">
                        <div class="card-body bg-slate-300 font-body text-slate-700 rounded-3 shadow-md">
                            <form method="POST" action="{{ route('update.book', $book_info->id) }}">
                                @csrf
                                @method('put')
                                <div class="form-group">
                                    <label class="text-lg font-medium" for="titleInput">Title <span class="text-xs">(required)</span></label>
                                    <input class="w-full bg-slate-200 outline-[0.5px] outline-slate-400/60 px-2 h-8 text-base rounded-3 mb-2" type="text" id="titleInput" name="title" autocomplete="off" placeholder="{{ $book_info->title }}" value="{{ $book_info->title }}">
                                    <label class="text-lg font-medium" for="subtitleInput">Subtitle</label>
                                    <input class="w-full bg-slate-200 outline-[0.5px] outline-slate-400/60 px-2 h-8 text-base rounded-3 mb-2" type="text" id="subtitleInput" name="subtitle" autocomplete="off" placeholder="{{ $book_info->subtitle }}" value="{{ $book_info->subtitle }}">
                                    <label class="text-lg font-medium" for="authorInput">Author <span class="text-xs">(required)</span></label>
                                    <input class="w-full bg-slate-200 outline-[0.5px] outline-slate-400/60 px-2 h-8 text-base rounded-3 mb-2" type="text" id="authorInput" name="author" autocomplete="off" placeholder="{{ $book_info->author }}" value="{{ $book_info->author }}">
                                    ...
                                    <div class="row g-0 text-center mb-3">
                                        ...
                                        <input class="btn-check" type="radio" id="reading" value="reading" name="condition" autocomplete="off" checked>
                                        @else
